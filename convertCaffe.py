...
def convertToCaffe(graph, prototxt_save_path, caffe_model_save_path, exis_focus=False, focus_concat_name=None, focus_conv_name=None):  # 如果有 focus 层，自己添加参数
    ...
    for id, layer in enumerate(layers):
        ...
        print("1111111111111111111111111111111111111111111111111111", layers[id])
    ...
    print("113333333333333333333333333333333333311111111111111111111", layers[id])
    ...
    for id, node in enumerate(graph.nodes):
        ...
        print("node_name = ", node_name, "op_type = ", op_type, "inputs = ", inputs)
...
if __name__ == "__main__":
    ...
    onnx_path = "weights/truck-sim.onnx"
    prototxt_path = "weights/truck.prototxt"
    caffemodel_path = "weights/truck.caffemodel"
